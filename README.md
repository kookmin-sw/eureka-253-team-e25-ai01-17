...
<!-- 활동 사진 추가 예시 -->
<img src="https://github.com/kookmin-sw/eureka-253-team-e25-ai01-17/blob/5d056e4183cf4c31934d779d71232c63dcdf30bd/%E1%84%89%E1%85%B3%E1%86%AF%E1%84%85%E1%85%A1%E1%84%8B%E1%85%B5%E1%84%83%E1%85%B31.png" />
...
- 우리 17팀에선 Machine Learning & Pattern Recognition Lab(MLPR Lab)에서 연구 중인 대학원 선배님을 인터뷰하였다. 선배님께선 현재 석사 과정에 있으며, 머신러닝과 패턴인식을 중심으로 다양한 데이터 분석 모델을 연구하고 있다. 연구실에서는 지도·비지도 학습 모델 개발, 딥러닝 기반 분류 모델 설계, 패턴 분석 등 폭넓은 주제를 다루고 있다고 소개해 주었다. 학부에서 배운 이론이 실제 연구문제에 어떻게 적용되는지 직접 체감할 수 있다는 점이 인상적이었다고 말하며, 연구가 단순히 코드 구현을 넘어서 논리적 사고와 실험 설계 능력을 요구하는 과정이라는 점도 강조하였다.
대학원에 진학한 이유를 묻자 선배는 비교적 솔직하고 담담하게 답해주었다. 학부 생활을 하며 인공지능 분야가 매우 흥미로웠지만, 강의만으로는 깊이 이해하기 어렵다는 한계를 느꼈고, 실제 연구를 수행하기 위해서는 더 많은 공부가 필요하다고 생각해 대학원을 선택했다고 한다. 진학 자체가 거창한 목표 때문이라기보다는, 학문적으로 성장하고 싶은 마음에서 비롯된 결정이었다는 점이 특히 기억에 남았다.
연구실 생활은 생각보다 훨씬 자율적이라고 한다. 스스로 공부 계획을 세우고 필요한 기술을 찾아 배우는 일이 많고, 교수님과의 정기적인 미팅을 통해 연구 방향을 조율하는 방식으로 연구가 진행된다. 선배는 연구 과정에서 가장 중요한 요소로 ‘기초 체력’을 꼽았다. 머신러닝을 제대로 이해하기 위해서는 선형대수, 확률, 통계 등 수학적 기반이 필수적이며, 코드 구현 능력이 탄탄해야 다양한 모델을 실험하고 분석할 수 있기 때문이다. 또한 꾸준한 논문 읽기 습관이 중요하다고 조언했는데, 처음에는 어려워 보이지만 반복해서 읽다 보면 흐름과 구조가 보이고, 연구 트렌드를 파악하는 데 큰 도움이 된다고 말했다. 프로젝트 경험 역시 학부생에게 매우 유익하다고 강조했는데, 작은 문제라도 스스로 정의하고 해결해보는 과정이 연구 감각을 키우는 데 큰 역할을 한다고 한다.
학부생인 나에게 선배는 조급해하지 말라는 조언을 전했다. 1학년 때부터 연구 분야를 빨리 정하려고 지나치게 고민하기보다, 여러 분야를 경험하면서 진짜 흥미를 느끼는 부분을 찾는 과정이 필요하다고 말했다. 또한 기초 과목은 가볍게 보지 말고 충실히 학습해 둘 것을 권했다. 인공지능 분야는 빠르게 변화하지만, 결국 새로운 기술을 이해하고 응용하는 능력을 결정하는 것은 기본기이기 때문이다. 마지막으로 선배는 꾸준함의 중요성을 강조했다. 하루에 조금씩이라도 공부하고 실습하는 습관이 쌓여 결국 대학원 생활과 연구 능력을 크게 좌우한다고 했다.
이번 인터뷰를 통해 대학원 생활이 단순히 어렵고 고된 과정이라는 막연한 인식에서 벗어나, 스스로 문제를 정의하고 해결하는 능력을 기르는 중요한 단계라는 점을 느낄 수 있었다. 석사 연구 방향과 실제 연구 환경에 대해 직접 들으며, 학부에서 배우는 내용이 어떻게 연구로 이어지는지 보다 구체적으로 이해하게 되었고, 앞으로의 학업 목표를 설정하는 데에도 큰 도움이 되었다. 무엇보다 선배의 솔직한 경험담과 조언을 통해 인공지능 분야를 공부하는 데 필요한 자세와 학습 태도에 대해 다시 한 번 생각해 볼 수 있었다. 

# 12주차 활동: 나의 지도교수님 함께 만나기
<img src="https://github.com/kookmin-sw/eureka-253-team-e25-ai01-17/blob/555e61b9bede13cb6aa89a4bff6df91977715468/1.png" />
<img src="https://github.com/kookmin-sw/eureka-253-team-e25-ai01-17/blob/555e61b9bede13cb6aa89a4bff6df91977715468/2.png" />
